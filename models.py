...
name1 = "(i = 1): 46555"
net1 = getNetwork(input_size, 100, 1, 46555)

name2 = "(i = 2): 8984"
net2 = getNetwork(input_size, 100, 2, 8984)

name3 = "(i = 3): 6554"
net3 = getNetwork(input_size, 100, 3, 6554)

name4 = "(i = 4): 5427"
net4 = getNetwork(input_size, 100, 4, 5427)

name5 = "(i = 5): 4739"
net5 = getNetwork(input_size, 100, 5, 4739)

name6 = "(i = 6): 4262"
net6 = getNetwork(input_size, 100, 6, 4262)

name7="(i = 7): 3907"
net7 = getNetwork(input_size, 100, 7, 3907)

name8="(i = 8): 3629"
net8 = getNetwork(input_size, 100, 8, 3629)

name9="(i = 9): 3404"
net9 = getNetwork(input_size, 100, 9, 3404)

name10="(i = 10): 3216"
net10 = getNetwork(input_size, 100, 10, 3216)
